...
from exchange.gp_binance import final_price_binance
from exchange.gp_binance_usdt import final_price_binance_crypto_usdt
...
async def main():
    ...
    tasks = [
        ...
        call_and_append(final_price_binance_crypto_usdt, result_list),
